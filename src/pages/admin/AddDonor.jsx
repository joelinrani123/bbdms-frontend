...
const emptyForm = { fullName: "", mobileNumber: "", emailId: "", age: "", gender: "", bloodGroup: "", address: "" };
...
export default function AddDonor() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await api.post("/admin/donors", { ...form, age: Number(form.age) });
  ...
  return (
    <>
      <h1 className="page-title">Add Donor</h1>
